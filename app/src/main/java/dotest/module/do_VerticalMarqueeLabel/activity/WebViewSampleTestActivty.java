package dotest.module.do_VerticalMarqueeLabel.activity;
...
import doext.module.do_VerticalMarqueeLabel.implement.do_VerticalMarqueeLabel_Model;
import doext.module.do_VerticalMarqueeLabel.implement.do_VerticalMarqueeLabel_View;
import dotest.module.do_VerticalMarqueeLabel.R;
import dotest.module.do_VerticalMarqueeLabel.debug.DoService;
...
public class WebViewSampleTestActivty extends DoTestActivity {
    ...
    protected void initModuleModel() throws Exception {
        this.model = new do_VerticalMarqueeLabel_Model();
    }

    @Override
    protected void initUIView() throws Exception {
        do_VerticalMarqueeLabel_View view = new do_VerticalMarqueeLabel_View(this);
    ...
    public void doTestProperties(View view) {
        ...
        DoService.setPropertyValue(this.model, "direction", "down");

        String data = "[aaaaaaaaaaaaa,bbbbbbbbbbbbbbb,ccccccccccccccccc,dddddddddddddd]";
        DoService.setPropertyValue(this.model, "text", data);
    }
